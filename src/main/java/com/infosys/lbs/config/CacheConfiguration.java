package com.infosys.lbs.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.infosys.lbs.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.infosys.lbs.repository.UserRepository.USERS_BY_EMAIL_CACHE);
